...
% Nesse item, faremos o parâmetro "N" variar, ou seja, o número de indivíduos na economia
% (e, logo, o tamanho da "fila". A idéia é torná-lo crescente até o ponto
...
% acrescentando-se o loop para fazer a iteração em torno do valor de N desejado.
...
iterN=0;
P_Esperado_Mentir=0;
P_Esperado_Verdade=1;

while (P_Esperado_Mentir < P_Esperado_Verdade) && (iterN < 600)
    N = N + 1;   % ou seja, estamos fazendo N (inteiro) se elevar em incrementos de 1 em 1.
                 % (o que isso implica em termos de dotação total está logo abaixo). 
    iterN = iterN + 1;
